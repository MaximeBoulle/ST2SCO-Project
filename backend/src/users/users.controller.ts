import { Controller, Post, Body, Get, UseGuards, Patch, Param, Request, ForbiddenException } from '@nestjs/common';
...
export class UsersController {
  ...
  @Patch(':id')
  async update(@Param('id') id: string, @Body() body: Partial<User>, @Request() req) {
    const user = req.user;
